                        ...
                        <div class="block-order-item">
                            <div class="order-item is-flex">
                                <div class="order-item__img">
                                    <img src="images/hinh_sp/ADIDAS ADIFOM Q OFF-WHITE 1.png" alt="">
                                </div>
                                <div class="order-item__info is-flex-direction-column">'
                                    <div class="info__title">đấ</div>
                                    <div class="info__sub-title">dasdasd</div>
                                    <div class="info__sub-title">dadas</div>
                                    <div class="info__group is-flex is-justify-content-space-between">
                                        <div class="price">dasdasd</div>
